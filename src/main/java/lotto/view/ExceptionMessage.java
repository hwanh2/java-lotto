...
public class ExceptionMessage {
    ...
    private static final String NOT_MINIMUM_AMOUNT_ERROR = "[ERROR] 금액은 1000원 이상이어야 합니다.";
    ...
    public static void minimumException() {
        System.out.println(NOT_MINIMUM_AMOUNT_ERROR);
    }
